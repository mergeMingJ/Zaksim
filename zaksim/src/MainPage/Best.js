...
export default function Best() {
  ...
  return (
    <Box style={{backgroundColor: '#274555', padding:'50px'}}>
      <Container>
      <Typography variant="h4" style={{margin:'10px 0', fontWeight: 'bold', color:'white'}}>인생은 도전하는거야!</Typography>
              ...
              <Card className={classes.root} variant="outlined">
                <CardContent style={{ padding: 0 }}>
                  <div className={classes.cardImage}>
                    ...
                    <Typography variant="h5" className={classes.cardName}>100일 운동</Typography>
                  </div>
                </CardContent>
